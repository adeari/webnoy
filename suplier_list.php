...
define("FileName", "suplier_list.php");
...
class clsRecordm_suplierSearch { //m_suplierSearch Class @2-7972187D
...
//Class_Initialize Event @2-5CCA453A
    function clsRecordm_suplierSearch($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record m_suplierSearch/Error";
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "m_suplierSearch";
...
//Operation Method @2-37A5AC5E
    function Operation()
    {
        ...
        $Redirect = "suplier_list.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "suplier_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End m_suplierSearch Class @2-FCB6E20C

class clsGridm_suplier { //m_suplier class @9-8624B687
...
//Class_Initialize Event @9-7CEF8FA3
    function clsGridm_suplier($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid m_suplier";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        ...
        $this->SorterName = CCGetParam("m_suplierOrder", "");
        $this->SorterDirection = CCGetParam("m_suplierDir", "");

        $this->kd_sup = & new clsControl(ccsLink, "kd_sup", "kd_sup", ccsText, "", CCGetRequestParam("kd_sup", ccsGet, NULL), $this);
        $this->kd_sup->Page = "suplier_isi.php";
        ...
        $this->m_suplier_Insert = & new clsControl(ccsLink, "m_suplier_Insert", "m_suplier_Insert", ccsText, "", CCGetRequestParam("m_suplier_Insert", ccsGet, NULL), $this);
        $this->m_suplier_Insert->Parameters = CCGetQueryString("QueryString", array("kd_sup", "ccsForm"));
        $this->m_suplier_Insert->Page = "suplier_isi.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->kd_sup->Parameters = CCAddParam($this->kd_sup->Parameters, "kd_sup", $this->DataSource->f("kd_sup"));
...
} //End m_suplier Class @9-FCB6E20C

class clsm_suplierDataSource extends clsDBMyCon {  //m_suplierDataSource Class @9-9E707F87
...
//SetOrder Method @9-828F292A
    function SetOrder($SorterName, $SorterDirection)
    {
        ...
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_kd_sup" => array("kd_sup", ""), 
...
//Prepare Method @9-71314EEE
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "kd_sup", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
...
} //End m_suplierDataSource Class @9-FCB6E20C
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "suplier_list.html";
$BlockToParse = "main";
...
include_once("./suplier_list_events.php");
...
// Controls
$m_suplierSearch = & new clsRecordm_suplierSearch("", $MainPage);
$m_suplier = & new clsGridm_suplier("", $MainPage);
...
$header->Initialize();
$MainPage->m_suplierSearch = & $m_suplierSearch;

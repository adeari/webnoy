...
define("FileName", "report_labarugi.php");
...
//Class_Initialize Event @2-5CCA453A
    function clsRecordm_trxjualSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->tanggal1 = & new clsControl(ccsTextBox, "tanggal1", "tanggal1", ccsText, "", CCGetRequestParam("tanggal1", $Method, NULL), $this);
			$this->DatePicker1 = & new clsDatePicker("DatePicker1",$this->ComponentName, "tanggal1", $this);
            $this->tanggal1->Required = true;
			$this->tanggal2 = & new clsControl(ccsTextBox, "tanggal2", "tanggal2", ccsText, "", CCGetRequestParam("tanggal2", $Method, NULL), $this);
			$this->DatePicker2 = & new clsDatePicker("DatePicker2", $this->ComponentName, "tanggal2", $this);
            $this->tangga2->Required = true;
...
//Show Method @2-568DDF12
    function Show()
    {
		...
		$this->tanggal1->SetValue(date('d/m/Y'));
		$this->tanggal1->Show();
		$this->DatePicker1->Show();
		$this->tanggal2->SetValue(date('d/m/Y'));
		$this->tanggal2->Show();
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "report_labarugi.html";
$BlockToParse = "main";

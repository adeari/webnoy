...
global $DBIntranetDB;	
  ...
  //kd_kos LIKE F% L%", where F = First Name, L = Last Name.
  ...
  $employees->ds->Where .= "kd_kos LIKE ".$DBIntranetDB->ToSQL($search_name,ccsText) ." or nama_kos LIKE ".$DBIntranetDB->ToSQL($search_name,ccsText)." or alamat LIKE ".$DBIntranetDB->ToSQL($search_name,ccsText)." or tlp LIKE ".$DBIntranetDB->ToSQL($search_name,ccsText);

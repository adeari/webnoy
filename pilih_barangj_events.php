...
global $DBIntranetDB;	
  ...
  //kd_brg LIKE F% L%", where F = First Name, L = Last Name.
  ...
  $employees->ds->Where .= "kd_brg LIKE ".$DBIntranetDB->ToSQL($search_name,ccsText) ." or nama_brg LIKE ".$DBIntranetDB->ToSQL($search_name,ccsText);

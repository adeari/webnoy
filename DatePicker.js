...
function buildTop() 
{
  ...
  {
    imgPrevYear = DatePickerObject.themePath+"gambar/Back.gif";
    imgPrevMonth = DatePickerObject.themePath+"gambar/Prev.gif";
    imgNextMonth = DatePickerObject.themePath+"gambar/Next.gif";
    imgNextYear = DatePickerObject.themePath+"gambar/Forward.gif";
  }
...
function buildDatePickerParts()
{
  ...
  if (DatePickerObject.themeVersion=="3.0")
  {
    ...
    var imgToday = DatePickerObject.themePath+"gambar/"+translation_language+"/ButtonToday.gif";

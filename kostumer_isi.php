...
define("FileName", "kostumer_isi.php");
...
class clsRecordm_kostumer { //m_kostumer Class @2-517D2D68
...
//Class_Initialize Event @2-078993BB
    function clsRecordm_kostumer($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record m_kostumer/Error";
        ...
        if($this->Visible)
        {
            ...
            $this->kd_kos = & new clsControl(ccsTextBox, "kd_kos", $CCSLocales->GetText("Text1"), ccsText, "", CCGetRequestParam("kd_kos", $Method, NULL), $this);
...
//Initialize Method @2-7EBC7CF7
    function Initialize()
    {
        ...
        $this->DataSource->Parameters["urlkd_kos"] = CCGetFromGet("kd_kos", NULL);
    }
...
//Validate Method @2-869B3DAC
    function Validate()
    {
		...
		$Validation = ($this->nama_kos->Validate() && $Validation);
		...
		$Validation =  $Validation && ($this->nama_kos->Errors->Count() == 0);
...
//CheckErrors Method @2-E37BA021
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->nama_kos->Errors->Count());
...
//Operation Method @2-805416FA
    function Operation()
    {
        ...
        $Redirect = "kostumer_list.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//InsertRow Method @2-BC7EBE1D
    function InsertRow()
    {
		...
		$this->DataSource->nama_kos->SetValue($this->nama_kos->GetValue(true));
...
//Show Method @2-75630EA0
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
					...
					$this->DataSource->alamat->GetValue();
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
			...
			$Error = ComposeStrings($Error, $this->nama_kos->Errors->ToString());
...
} //End m_kostumer Class @2-FCB6E20C

class clsm_kostumerDataSource extends clsDBMyCon {  //m_kostumerDataSource Class @2-9E707F87
...
//DataSourceClass_Initialize Event @2-4D840E43
    function clsm_kostumerDataSource(& $Parent)
    {
		...
		$this->InsertFields["nama_kos"] = array("Name" => "nama_kos", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
		...
		$this->UpdateFields["nama_kos"] = array("Name" => "nama_kos", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//Prepare Method @2-1EF17CE9
    function Prepare()
    {
        ...
        $this->wp->AddParameter("1", "urlkd_kos", ccsText, "", "", $this->Parameters["urlkd_kos"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "kd_kos", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
//Insert Method @2-B90AA189
    function Insert()
    {
        ...
        $this->InsertFields["nama_kos"]["Value"] = $this->nama_kos->GetDBValue(true);
        $this->InsertFields["kd_kos"]["Value"] = $this->kd_kos->GetDBValue(true);
		$this->InsertFields["tlp"]["Value"] = $this->tlp->GetDBValue(true);
        $this->SQL = CCBuildInsert("tb_kostumer", $this->InsertFields, $this);
...
//Update Method @2-F5617834
    function Update()
    {
        ...
        $this->UpdateFields["nama_kos"]["Value"] = $this->nama_kos->GetDBValue(true);
        $this->UpdateFields["kd_kos"]["Value"] = $this->kd_kos->GetDBValue(true);
		$this->UpdateFields["tlp"]["Value"] = $this->tlp->GetDBValue(true);
        $this->SQL = CCBuildUpdate("tb_kostumer", $this->UpdateFields, $this);
...
//Delete Method @2-6C1BE75C
    function Delete()
    {
        ...
        $this->SQL = "DELETE FROM tb_kostumer";
...
} //End m_kostumerDataSource Class @2-FCB6E20C
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "kostumer_isi.html";
$BlockToParse = "main";
...
// Controls
$m_kostumer = & new clsRecordm_kostumer("", $MainPage);

...
define("FileName", "cetakbarangstok.php");
...
//Open Method @9-6109A04B
    function Open()
    {
		...
		if (strlen(CCGetFromGet("jojo", NULL))>0)
			$this->barang=" kd_brg='".CCGetFromGet("jojo", NULL)."' ";
		if (strlen($this->barang)>0&&strlen(CCGetFromGet("joji", NULL))>0)
			$this->barang.=" or nama_brg like '%".CCGetFromGet("joji", NULL)."%' ";
		else if (strlen(CCGetFromGet("joji", NULL))>0)
			$this->barang=" nama_brg like '%".CCGetFromGet("joji", NULL)."%' ";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "cetakbarangstok.html";
$BlockToParse = "main";

...
define("FileName", "pilih_supj.php");
...
class clsRecordpilih_nama_kosSearch { //pilih_nama_kosSearch Class @8-EFB2F51A
...
//Class_Initialize Event @8-61F517FD
    function clsRecordpilih_nama_kosSearch($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record pilih_nama_kosSearch/Error";
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "pilih_nama_kosSearch";
			...
			$this->s_nama_kos = & new clsControl(ccsTextBox, "s_nama_kos", "s_nama_kos", ccsText, "", CCGetRequestParam("s_nama_kos", $Method, NULL), $this);
...
//Validate Method @8-D66FF3C9
    function Validate()
    {
        ...
        $Validation = ($this->s_nama_kos->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        $Validation =  $Validation && ($this->s_katanya->Errors->Count() == 0);
        $Validation =  $Validation && ($this->s_nama_kos->Errors->Count() == 0);
...
//CheckErrors Method @8-50309F58
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->s_nama_kos->Errors->Count());
...
//Operation Method @8-16919BF1
    function Operation()
    {
        ...
        $Redirect = "pilih_supj.php";
        if($this->Validate()) {
            if($this->PressedButton == "DoSearch") {
                $Redirect = "pilih_supj.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("DoSearch", "DoSearch_x", "DoSearch_y")));
...
//Show Method @8-17E06891
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->s_nama_kos->Errors->ToString());
...
} //End pilih_nama_kosSearch Class @8-FCB6E20C
...
//Show Method @2-22CE2510
    function Show()
    {
        ...
        $this->DataSource->Parameters["urls_nama_kos"] = CCGetFromGet("s_nama_kos", NULL);
...
//Open Method @2-5538DF5A
    function Open()
    {
        ...
        $this->CountSQL = "SELECT COUNT(*) FROM tb_kostumer";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "pilih_supj.html";
$BlockToParse = "main";
...
include_once("./pilih_supj_events.php");
...
$Link1->Page = "";
$pilih_nama_kosSearch = & new clsRecordpilih_nama_kosSearch("", $MainPage);
$employees = & new clsGridemployees("", $MainPage);
$MainPage->Link1 = & $Link1;
$MainPage->pilih_nama_kosSearch = & $pilih_nama_kosSearch;
...
$pilih_nama_kosSearch->Operation();

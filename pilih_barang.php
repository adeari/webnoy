...
define("FileName", "pilih_barang.php");
...
//Operation Method @8-16919BF1
    function Operation()
    {
        ...
        $Redirect = "pilih_barang.php";
        if($this->Validate()) {
            if($this->PressedButton == "DoSearch") {
                $Redirect = "pilih_barang.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("DoSearch", "DoSearch_x", "DoSearch_y")));
...
function pengkodean($data)
{
    ...
    function SetValues()
    {
		...
		$this->hrg_belinya->SetDBValue($this->setuang($this->f("hrg_belinya")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "pilih_barang.html";
$BlockToParse = "main";
...
include_once("./pilih_barang_events.php");
